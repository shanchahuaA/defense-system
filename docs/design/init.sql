...
CREATE TABLE department (
    ...
    dean_name VARCHAR(50) COMMENT '系主任姓名',
    description TEXT COMMENT '院系简介',
    dean_signature VARCHAR(255) COMMENT '系主任签名图片路径',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) COMMENT '院系表';
-- ============================================
...
CREATE TABLE sys_user (
    ...
    signature VARCHAR(255) COMMENT '签名图片路径',
...
CREATE TABLE defense_group (
    ...
    thesis_type VARCHAR(20) COMMENT '毕业类型：PAPER/DESIGN',
    location VARCHAR(100) COMMENT '答辩地点',
    defense_time VARCHAR(50) COMMENT '答辩时间',
...
CREATE TABLE student (
    ...
    defense_order INT COMMENT '答辩顺序',
    group_avg_score DECIMAL(5, 2) COMMENT '小组平均成绩',
    final_group_score DECIMAL(5, 2) COMMENT '大组平均成绩',
